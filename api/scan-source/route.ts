  ...
  const HARDENED_FILES: { rel: string; required: { label: string; pattern: RegExp }[] }[] = [
    {
      ...
      required: [
        ...
        { label: "allowUserSuppliedJavascript: true", pattern: /allowUserSuppliedJavascript:\s*true/ },
      ],
    },
    {
      ...
      required: [
        ...
        { label: "setUser accepts resolvedConfigId", pattern: /export\s+(async\s+)?function\s+setUser\s*\([^)]*resolvedConfigId/ },
        { label: "explicit else branch in setUser", pattern: /\}\s*else\s*\{/ },
        { label: "native branch startSession", pattern: /startSession\s*\(/ },
        { label: "browser fallback braze identity write", pattern: /changeUser\s*\(/ },
    ...
    },
    {
      ...
      required: [
        ...
        { label: "configId native override", pattern: /configId\s*\?\?\s*fallbackConfigId/ },
